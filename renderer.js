  ...
  */
  ...
  function buildPolyline() {
    ...
    for (let i = 0; i < onFloor.length; i++) {
      ...
      const isElPassage = ['corridor', 'door', 'elevator', 'staircase', 'hall', 'window', 'entry_exit', 'waypoint'].includes(elType) || elType.startsWith('corridor') || el.isStairs;
      if (!isElPassage) {
  ...
  onFloor.forEach(elId => {
    ...
    const isElPassage = ['corridor', 'door', 'elevator', 'staircase', 'hall', 'window', 'entry_exit', 'waypoint'].includes(elType) || elType.startsWith('corridor') || rec.el.isStairs;
    if (!isElPassage) {
