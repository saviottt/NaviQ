...
function renderCanvas() {
  ...
  floorWalls.forEach(wall => {
    ...
    delBtn.className = 'wall-del-btn wall-cancel-btn';
    delBtn.textContent = '✕';
    delBtn.title = 'Delete wall';
    if (isHoriz) {
      delBtn.style.cssText = 'right:-10px;top:50%;bottom:auto;left:auto;transform:translateY(-50%);';
    } else {
      delBtn.style.cssText = 'bottom:-10px;left:50%;top:auto;right:auto;transform:translateX(-50%);';
    }
    ...
    re.className = 'wall-resize-end wall-extend-handle';
    if (isHoriz) {
      re.style.cssText = 'left:-6px;top:50%;bottom:auto;right:auto;transform:translateY(-50%);cursor:ew-resize;';
    } else {
      re.style.cssText = 'top:-6px;left:50%;bottom:auto;right:auto;transform:translateX(-50%);cursor:ns-resize;';
    }
